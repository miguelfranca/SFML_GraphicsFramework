...
namespace GF {
	...
	public:
		...
		Rectangle(sf::Vector2f size, sf::Vector2f pos = TOPLEFT_F, GF::Alignment origin = GF::CENTERED, sf::Color fill = sf::Color::White, sf::Color outline = sf::Color::Transparent, float thickness = 0);
	...
	public:
		Line(sf::Vector2f pos1 = sf::Vector2f(0, 0), sf::Vector2f pos2 = sf::Vector2f(0, 0), sf::Color color1 = sf::Color::White, sf::Color color2 = sf::Color::White);
